...
```
cd existing_repo
git remote add origin https://gitlab.hzdr.de/haicu/internal-projects/hematology_data_challenge.git
git branch -M main
...
- [ ] [Set up project integrations](https://gitlab.hzdr.de/haicu/internal-projects/hematology_data_challenge/-/settings/integrations)
